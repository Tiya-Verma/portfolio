    ...
    >
      ...
      >
        ...
        <div className="text-gray-100 text-lg md:text-xl font-normal leading-relaxed mb-6 text-left w-full" style={{fontFamily:'Quicksand,sans-serif'}}>
          I'm a second year student at The University of British Columbia. I strive to develop technical solutions and designs that provide a smarter and analytical approach to problem solving. I am currently majoring in Computer Science and I aim to showcase my creative expression through tech. I work great in teams and in leadership roles. When I'm not working, you'll find me dabbling in desserts.<br/>Let's connect!
        </div>
        {/* Social icons row with gradients */}
        <div className="w-full flex justify-center items-center gap-8 mt-6 mb-2">
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/tiyaverma//" target="_blank" rel="noopener noreferrer" onClick={handleLinkClick}>
            <div className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-br from-cyan-300 via-blue-400 to-pink-400 shadow-lg transform transition-transform duration-300 hover:scale-125">
          ...
          {/* GitHub */}
          <a href="https://github.com/Tiya-Verma/" target="_blank" rel="noopener noreferrer" onClick={handleLinkClick}>
            <div className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-br from-pink-400 via-yellow-300 to-cyan-300 shadow-lg transform transition-transform duration-300 hover:scale-125">
          ...
          {/* Email */}
          <a href="mailto:tiyaverma2004@yahoo.in" target="_blank" rel="noopener noreferrer" onClick={handleLinkClick}>
            <div className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-br from-yellow-300 via-pink-400 to-cyan-300 shadow-lg transform transition-transform duration-300 hover:scale-125">
